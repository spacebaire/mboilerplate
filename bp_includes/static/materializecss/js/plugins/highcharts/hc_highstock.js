...
(function() {
    ...
    var r, E = document,
        ...
        Rb = T.opera,
        Ea = /(msie|trident)/i.test(Ha) && !Rb,
        nb = E.documentMode === 8,
        Gb = /AppleWebKit/.test(Ha),
        Va = /Firefox/.test(Ha),
        fb = /(Mobile|Android|Windows Phone)/.test(Ha),
        Ia = "http://www.w3.org/2000/svg",
        ea = !! E.createElementNS && !! E.createElementNS(Ia, "svg").createSVGRect,
        Wb =
            Va && parseInt(Ha.split("Firefox/")[1], 10) < 4,
        ma = !ea && !Ea && !! E.createElement("canvas").getContext,
        Wa, $a, Sb = {}, Hb = 0,
        lb, F, ka, Ga, Ib, H, ha = function() {
            return r
        }, ca = [],
        gb = 0,
        Ua = "div",
        ...
        Yb = "stroke-width",
        fa, mb, ub, kb, yb, zb, Ab, cb, db, eb, Ob, Pb, Bb, Cb, Db, I = {}, z;
    ...
    $.prototype = {
        ...
        applyTextShadow: function(a) {
            var b = this.element,
                ...
                e = this.renderer.forExport || b.style.textShadow !==
                    r && !Ea;
        ...
        getBBox: function(a) {
            ...
            if (!b) {
                if (f.namespaceURI === Ia || c.forExport) {
                    ...
                    if (e) b.width = R(d * ga(h)) + R(a * ba(h)), b.height = R(d * ba(h)) + R(a *
                        ga(h))
                }
                c.cache[l] = b
            }
    ...
    $.prototype["stroke-widthSetter"] = $.prototype.strokeSetter = function(a, b, c) {
        this[b] = a;
        if (this.stroke && this["stroke-width"]) this.strokeWidth = this["stroke-width"], $.prototype.fillSetter.call(this, this.stroke, "stroke", c), c.setAttribute("stroke-width",
    ...
    na.prototype = {
        ...
        buildText: function(a) {
            ...
            !f && !o && !q && e.indexOf(" ") === -1 ? b.appendChild(E.createTextNode(u(e))) : (h = /<.*style="([^"]+)".*>/, i = /<.*href="(http[^"]+)".*>/, J && J.appendChild(b), e = f ? e.replace(/<(b|strong)>/g, '<span style="font-weight:bold">').replace(/<(i|em)>/g, '<span style="font-style:italic">').replace(/<a/g, "<span").replace(/<\/(b|strong|i|em|a)>/g, "</span>").split(/<br.*?>/g) : [e], e[e.length - 1] === "" && e.pop(), n(e, function(e, f) {
                ...
                n(g, function(e) {
                    if (e !==
                        "" || g.length === 1) {
                        var o = {}, t = E.createElementNS(Ia, "tspan"),
                            J;
                        ...
                        if (e !== " ") {
                            ...
                            if (l) {
                                for (var o = e.replace(/([^\^])-/g, "$1- ").split(" "), n = g.length >
                                    ...
                                    (n || q) && (o.length || s.length);) a.rotation = 0, p = a.getBBox(!0), r = p.width, !ea && c.forExport && (r = c.measureSpanWidth(t.firstChild.data, a.styles)), p = r > l, A === void 0 && (A = p), q && A ? (B /= 2, y === "" || !p && B < 0.5 ? o = [] : (p && (A = !0), y = e.substring(0, y.length + (p ? -1 : 1) * za(B)), o = [y + "â€¦"], t.removeChild(t.firstChild))) : !p || o.length === 1 ? (o = s, s = [], o.length && (v++, t = E.createElementNS(Ia, "tspan"), W(t, {
                                        dy: w,
                                        x: j
        ...
        label: function(a, b, c, d, e, f, g, h, i) {
            ...
            function k() {
                ...
                if (b !== q.x || c !== q.y) q.attr("x", b), c !== r && q.attr(q.element.nodeName === "SPAN" ? "y" : "translateY", c);
                q.x = b;
                q.y = c
            }
    ...
    if (!ea && !ma) G = {
        ...
        color: function(a, b, c, d) {
            ...
            if (i) {
                ...
                if (c === "fill")
                    if (i === "gradient") c = m.x1 || m[0] || 0, a = m.y1 || m[1] || 0, o = m.x2 || m[2] || 0, m = m.y2 || m[3] || 0, u = 'angle="' + (90 - Y.atan((m - a) / (o - c)) * 180 / va) + '"', r();
                    else {
                        var j = m.r,
                            s = j * 2,
                            w = j * 2,
    ...
    Za.prototype = {
        ...
        render: function(a, b, c) {
            ...
            if (m && n) A === "inside" &&
                (n = -n), d.opposite && (n = -n), h = this.getMarkPath(x, v, n, m * y, g, f), o ? o.animate({
                d: h,
                opacity: c
    ...
    O.prototype = {
        ...
        setTickInterval: function(a) {
            ...
            if (b.range && s(b.max)) b.userMin = b.min = v(b.min, b.max - b.range), b.userMax = b.max, b.range =
                null;
        ...
        unsquish: function() {
            ...
            c ? (l = s(h) ? [h] : f < 80 && !b.staggerLines && !b.step && b.autoRotation) && n(l, function(a) {
                var b;
                if (a === h || a && a >= -90 && a <= 90) j = m(R(i.h / ga(ra * a))), b = j + R(a / 360), b < k && (k = b, g = a, e = j)
            }) : e = m(i.h);
            this.autoRotation = l;
        ...
        getOffset: function() {
            ...
            if (j || a.isLinked) {
                ...
                for (A in f) f[A].destroy(), delete f[A]; if (q && q.text && q.enabled !== !1) {
                ...
                if (k) l = a.axisTitle.getBBox()[g ? "height" : "width"], m = q.offset, o = s(m) ? 0 : p(q.margin, g ? 5 : 10);
        ...
        render: function() {
            ...
            if (t || f) {
                ...
                m && n(g, function(b, c) {
                    if (c % 2 === 0 && b < a.max) k[b] || (k[b] = new z.PlotLineOrBand(a)), u = b + o, A = g[c + 1] !== r ? g[c +
    ...
    O.prototype.getTimeTicks = function(a, b, c, d) {
        ...
        if (s(b)) {
            ...
            if (j >= H.day) i[Bb](j >= H.month ? 1 : k * X(i[cb]() / k));
            ...
            for (var d = i.getTime(), l = i[db](), m = i[cb](), o = (H.day + (g ? bb(i) : i.getTimezoneOffset() *
                    6E4)) % H.day; d < c;) e.push(d), j === H.year ? d = mb(h + b * k, 0) : j === H.month ? d = mb(h, l + b * k) : !g && (j === H.day || j === H.week) ? d = mb(h, l, m + b * k * (j === H.day ? 1 : 7)) : d += j * k, b++;
            e.push(d);
            n(hb(e, function(a) {
    ...
    O.prototype.getLogTickPositions = function(a, b, c, d) {
        ...
        if (a >= 0.5) a = w(a), g = this.getLinearTickPositions(a, b, c);
            ...
            } else if (b = ta(b), c = ta(c), a = e[d ? "minorTickInterval" : "tickInterval"], a = p(a === "auto" ? null : a, this._minorAutoInterval, (c - b) * (e.tickPixelInterval / (d ? 5 : 1)) / ((d ? f / this.tickPositions.length : f) || 1)), a = wb(a, null, vb(a)), g = Aa(this.getLinearTickPositions(a, b, c), La), !d) this._minorAutoInterval = a / 5;
    ...
    Xa.prototype = {
                ...
                for (f = 0; f < c.length; f++)
                    ...
                    (!h || !h.noSharedTooltip) && (e || !h) ? (n(c, function(b) {
                        ...
                        if (a && s(a.plotX) && s(a.plotY) &&
                            (a.dist.distX < i || (a.dist.distX === i || a.series.kdDimensions > 1) && a.dist.distR < j)) i = a.dist.distX, j = a.dist.distR, m = a
                    })) : m = h.directTouch && g || h && h.searchPoint(a);
            if (m && (m !== g || d && d.isHidden)) {
                if (e && !m.series.noSharedTooltip) {
                    f = l.length;
                    for (c = m.clientX; f--;) h = l[f].clientX, (l[f].x !== m.x || h !== c || l[f].series.noSharedTooltip) && l.splice(f, 1);
        ...
        reset: function(a, b) {
            ...
            if (a) f.refresh(g), e && (e.setState(e.state, !0), n(c.axes, function(b) {
                ...
                if (d) d.onMouseOut();
                f && f.hide(b);
                if (this._onDocumentMouseMove) U(E, "mousemove", this._onDocumentMouseMove), this._onDocumentMouseMove = null;
                n(c.axes, function(a) {
                    a.hideCrosshair()
                });
                this.hoverX = null
    ...
    rb.prototype = {
        init: function(a, b) {
            var c = this,
                ...
                e = b.itemMarginTop || 0;
            this.options = b;
            if (b.enabled) c.itemStyle = d, c.itemHiddenStyle = y(d, b.itemHiddenStyle), c.itemMarginTop = e, c.padding = d = p(b.padding, 8), c.initialItemX = d, c.initialItemY = d - 5, c.maxItemWidth = 0, c.chart = a, c.itemHeight = 0, c.symbolWidth = p(b.symbolWidth, 16), c.pages = [], c.render(), D(c.chart, "endResize",
                function() {
    ...
    Pa.prototype = {
        ...
        getChartSize: function() {
            ...
            if (!s(b)) this.containerWidth = pb(c, "width");
            if (!s(a)) this.containerHeight = pb(c, "height");
        ...
        setChartSize: function(a) {
            ...
            this.clipBox = {
                ...
                height: v(0, X(this.plotSizeY - v(d, h[2]) /
                    2 - c))
            };
    ...
    P.prototype = {
            ...
            if (d !== !1 && h && g === h && !e.cropped && !e.hasGroupedData && e.visible) n(a, function(a, b) {
                ...
                if (o && h > o) {
                    ...
                    for (c = 0; c < h; c++)
                        if (a[c] !== r && (i = {
                            series: e
                        }, e.pointClass.prototype.applyOptions.apply(i, [a[c]]), e.updateParallelArrays(i, c), m && i.name)) l.names[i.x] =
                            i.name; Ja(t[0]) && qa(14, !0);
                e.data = [];
                e.options.data = a;
        ...
        generatePoints: function() {
            ...
            for (m = 0; m < g; m++) i = h + m, j ? l[m] = (new f).init(this, [d[m]].concat(pa(e[m]))) : (b[i] ? k = b[i] : a[i] !== r && (b[i] = k = (new f).init(this, a[i], d[m])), l[m] = k), l[m].index = i;
            if (b && (g !== (c = b.length) || j))
                for (m =
                    0; m < c; m++)
                ...
                for (f = b.length; f--;)
                    if (g = b[f], d = X(g.plotX), e = g.plotY, k = g.graphic, o = g.marker || {}, q = !! g.marker, a = N && o.enabled === r || o.enabled, t = g.isInside, a && e !== r && !isNaN(e) && g.y !== null)
                        if (a = g.pointAttr[g.selected ? "select" : ""] || m, h = a.r, i = p(o.symbol,
                            this.symbol), j = i.indexOf("url") === 0, k) k[t ? "show" : "hide"](!0).animate(x({
                            x: d - h,
                            y: e - h
                        }, k.symbolName ? {
                            width: 2 * h,
            ...
            if (!j || g < j || l)
                for (; g--;) {
                    ...
                    if (l) {
                        ...
                        d = c.states || {};
                        f = d.hover = d.hover || {};
                        if (!b.marker) f.color = f.color || !j.options.color && e[j.negative && h ? "negativeColor" : "color"] || wa(j.color).brighten(f.brightness ||
                            e.brightness).get();
                        f = {
                            color: j.color
                        };
    ...
    Da = ja(P, {
        ...
        animate: function(a) {
            var b = this.yAxis,
                ...
                d = this.chart.inverted,
                e = {};
            if (ea) a ? (e.scaleY = 0.001, a = B(b.pos + b.len, v(b.pos, b.toPixels(c.threshold))), d ? e.translateX = a - b.len : e.translateY = a, this.group.attr(e)) : (e.scaleY = 1, e[d ? "translateX" : "translateY"] = b.pos, this.group.animate(e, this.options.animation), this.animate = null)
        },
        remove: function() {
            var a = this,
                b = a.chart;
    ...
    if (I.column) Da.prototype.drawTracker = jb.drawTrackerPoint;
    if (I.pie) I.pie.prototype.drawTracker = jb.drawTrackerPoint;
    if (I.scatter) ya.prototype.drawTracker = jb.drawTrackerPoint;
    x(rb.prototype, {
    ...
    S(O.prototype, "getTimeTicks", function(a, b, c, d, e, f, g, h) {
        ...
        if (!this.options.ordinal && !this.options.breaks || !f || f.length < 3 || c === r) return a.call(this,
            b, c, d, e);
        ...
        if (h && s(p)) {
            var h = a = t.length,
                j = [],
                u;
            for (m = []; h--;) i = this.translate(t[h]), u && (m[h] = u - i), j[h] = u = i;
            m.sort();
            m = m[X(m.length /
                2)];
            m < p * 0.6 && (m = null);
        ...
        if (c.options.ordinal && c.series.length) {
            ...
            if (m.ordinalPositions) {
                if (R(f) > 1) k && n(k, function(a) {
                    ...
                    m[m.length - 1] && m.push(h), this.fixedRange = j - i, f = c.toFixedRange(null, null, l.apply(k, [o.apply(k, [i, !0]) + f, !0]), l.apply(q, [o.apply(q, [j, !0]) + f, !0])), f.min >= B(g.dataMin, i) && f.max <= v(h, j) && c.setExtremes(f.min, f.max, !0, !1, {
                        trigger: "pan"
        ...
        drawPoints: function() {
            ...
            n(a.points, function(k) {
                if (k.plotY !== r) i = k.graphic, c = k.pointAttr[k.selected ? "selected" : ""] || a.pointAttr[""], f = c["stroke-width"] % 2 / 2, j = w(k.plotX) - f, g = w(k.shapeArgs.width / 2), h = ["M", j, w(k.yBottom), "L", j, w(k.plotY)], k.open !==
                    null && (d = w(k.plotOpen) + f, h.push("M", j, d, "L", j - g, d)), k.close !== null && (e = w(k.plotClose) + f, h.push("M", j, e, "L", j + g, e)), i ? i.attr(c).animate({
                        d: h
        ...
        drawPoints: function() {
            ...
            n(a.points, function(n) {
                ...
                if (n.plotY !== r) c = n.pointAttr[n.selected ? "selected" : ""] || d, k = c["stroke-width"] % 2 / 2, l = w(n.plotX) - k, e = n.plotOpen, f = n.plotClose, g = Y.min(e,
                    f), h = Y.max(e, f), q = w(n.shapeArgs.width / 2), i = w(g) !== w(n.plotY), j = h !== n.yBottom, g = w(g) + k, h = w(h) + k, o = ["M", l - q, h, "L", l - q, g, "L", l + q, g, "L", l + q, h, "Z", "M", l, g, "L", l, i ? w(n.plotY) : g, "M", l, h, "L", l, j ? w(n.yBottom) : h], m ? m.attr(c).animate({
                    d: o
    ...
    I.flags = ja(I.column, {
        ...
        translate: function() {
            ...
            n(b, function(c, d) {
                var f;
                if (c.plotY === r) c.x >= j.min && c.x <= j.max ? c.plotY = a.chartHeight - i.bottom - (i.opposite ?
        ...
        drawPoints: function() {
            ...
            for (j = c.length; j--;)
                if (k = c[j], a = k.plotX > this.xAxis.len, e = k.plotX + (a ? m : -m), l = k.stackIndex, i = k.options.shape || g.shape, f = k.plotY, f !== r && (f = k.plotY + h + m - (l !== r && l * g.stackDistance)), o = l ? r : k.plotX + m, n = l ? r : k.plotY, l = k.graphic,
                    f !== r && e >= 0 && !a) a = k.pointAttr[k.selected ? "select" : ""] || b, l ? l.attr({
                    x: e,
                    y: f,
                    r: a.r,
                    anchorX: o,
    ...
    Fb.prototype = {
        ...
        drawInput: function(a) {
            ...
            i.onchange = function() {
                ...
                isNaN(d) || (F.global.useUTC || (d += (new fa).getTimezoneOffset() * 6E4), h ? d > b.maxInput.HCTime ? d = r : d < g && (d = g) : d < b.minInput.HCTime ? d = r : d > j && (d = j), d !== r && c.xAxis[0].setExtremes(h ? d : e.min, h ? e.max : d, r, r, {
        ...
        render: function(a, b) {
            var c =
                ...
                g = c.inputGroup,
                l = i.buttonTheme,
                m = i.buttonPosition || {}, o = i.inputEnabled,
                q = l && l.states,
                t = d.plotLeft,
                r, v, u = c.group;
    ...
    if (Wa === z.VMLRenderer) ib.prototype.crispPolyLine = na.prototype.crispPolyLine;
    ...
    var lc = da.init,
        mc = da.processData,
        nc = Ca.prototype.tooltipFormatter;
    da.init = function() {
    ...
    S(P.prototype, "render", function(a) {
        if (this.chart.options._stock)!this.clipBox && this.animate && this.animate.toString().indexOf("sharedClip") !== -1 ? (this.clipBox = y(this.chart.clipBox),
            this.clipBox.width = this.xAxis.len, this.clipBox.height = this.yAxis.len) : this.chart[this.sharedClipKey] && (ab(this.chart[this.sharedClipKey]), this.chart[this.sharedClipKey].attr({
