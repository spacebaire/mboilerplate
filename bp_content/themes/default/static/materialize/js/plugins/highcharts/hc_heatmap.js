...
(function(h) {
    var l = h.Axis,
        ...
        p = h.seriesTypes,
        w = h.wrap,
        o = function() {}, q = h.ColorAxis = function() {
            this.isColorAxis = !0;
    ...
    s(q.prototype, {
        ...
        initDataClasses: function(a) {
            ...
            i(a.dataClasses, function(a, h) {
                var i, a = m(a);
                c.push(a);
                if (!a.color) f.dataClassColor === "category" ? (i = e.options.colors, a.color = i[d++], d === i.length && (d = 0)) : a.color = b.tweenColors(k(f.minColor),
        ...
        drawLegendSymbol: function(a, b) {
            var e = a.padding,
                c = a.options,
                d = this.horiz,
                f = n(c.symbolWidth, d ? 200 : 12),
                g = n(c.symbolHeight, d ? 12 : 200),
                j = n(c.labelPadding, d ? 16 : 30),
        ...
        drawCrosshair: function(a, b) {
            var e = b && b.plotX,
                ...
                d, f = this.pos,
                g = this.len;
            if (b) d = this.toPixels(b[b.series.colorKey]), d < f ? d = f - 2 : d > f + g && (d = f + g + 2), b.plotX = d, b.plotY = this.len - d, l.prototype.drawCrosshair.call(this, a, b), b.plotX = e, b.plotY = c, this.cross && this.cross.attr({
