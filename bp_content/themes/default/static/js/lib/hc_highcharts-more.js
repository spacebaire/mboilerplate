...
(function(k, D) {
    ...
    s(y, "getPosition", function(a, b, c, d, e) {
        var f = this.axis;
        return f.getPosition ? f.getPosition(c) : a.call(this, b, c, d, e)
    });
    s(y, "getLabelPosition", function(a, b, c, d, e, f, h, i, l) {
        var m = this.axis,
            j = f.y,
            n = 20,
            g = f.align,
    ...
    s(y, "getMarkPath", function(a, b, c, d, e, f, h) {
        var i = this.axis;
    ...
    g.boxplot = v(g.column, {
        ...
        drawPoints: function() {
            ...
            u(b, function(b) {
                ...
                y = b.color || a.color;
                if (b.plotY !== D)
                    if (e = b.pointAttr[b.selected ? "selected" : ""], v = z.width, t = B(z.x), w = t + v, x = E(v / 2), f = B(F ? b.q1Plot : b.lowPlot), h = B(F ? b.q3Plot : b.lowPlot), i = B(b.highPlot), l = B(b.lowPlot), k.stroke = b.stemColor || c.stemColor || y, k["stroke-width"] = q(b.stemWidth, c.stemWidth, c.lineWidth), k.dashstyle = b.stemDashStyle || c.stemDashStyle, o.stroke = b.whiskerColor || c.whiskerColor || y, o["stroke-width"] = q(b.whiskerWidth, c.whiskerWidth, c.lineWidth), r.stroke = b.medianColor || c.medianColor || y, r["stroke-width"] = q(b.medianWidth, c.medianWidth,
                        c.lineWidth), j = k["stroke-width"] % 2 / 2, n = t + x + j, A = ["M", n, h, "L", n, i, "M", n, f, "L", n, l], F && (j = e["stroke-width"] % 2 / 2, n = B(n) + j, f = B(f) + j, h = B(h) + j, t += j, w += j, J = ["M", t, h, "L", t, f, "L", w, f, "L", w, h, "L", t, h, "z"]), C && (j = o["stroke-width"] % 2 / 2, i += j, l += j, p = ["M", n - x * C, i, "L", n + x * C, i, "M", n - x * C, l, "L", n + x * C, l]), j = r["stroke-width"] % 2 / 2, m = E(b.medianPlot) + j, s = ["M", t, m, "L", w, m], g) b.stem.animate({
                        d: A
    ...
    g.waterfall = v(g.column, {
        ...
        translate: function() {
            ...
            for (c = 0, a = d.length; c < a; c++) {
                ...
                else if (e.isIntermediateSum) f.y = b.translate(j[1], 0, 1), f.height =
                    b.translate(m, 0, 1) - f.y, m = j[1];
                else {
        ...
        processData: function(a) {
            ...
            for (j = 0; j < e; j++) m = b[j], d = c && c[j] ? c[j] : {}, m === "sum" || d.isSum ? b[j] =
                h : m === "intermediateSum" || d.isIntermediateSum ? b[j] = f : (h += m, f += m), i = Math.min(h, i), l = Math.max(h, l);
    ...
    M.prototype.beforePadding = function() {
        var a = this,
            ...
            h = f ? "xData" : "yData",
            i = this.min,
            l = {}, m = w.min(c.plotWidth, c.plotHeight),
            j = Number.MAX_VALUE,
            n = -Number.MAX_VALUE,
            g = this.max - i,
            k = b / g,
        ...
        u(this.series, function(b) {
            ...
            if (b.bubblePadding && (b.visible || !c.options.chart.ignoreHiddenSeries))
                if (a.allowZoomOutside = !0, p.push(b), f) u(["minSize", "maxSize"], function(a) {
                    var b = h[a],
                        f = /%$/.test(b),
                        b = x(b);
                    l[a] = f ? m * b / 100 : b
    ...
    (function() {
        ...
        s(c, "buildKDTree", function(a) {
            if (this.chart.polar) this.kdAxisArray = ["clientX"];
            a.apply(this)
        });
        s(c, "searchPoint", function(a, b) {
        ...
        s(c, "animate", b);
        if (g.column) e = g.column.prototype, s(e, "animate", b), s(e, "translate", function(a) {
            var b = this.xAxis,
                c = this.yAxis.len,
                d = b.center,
                e = b.startAngleRad,
        ...
        }), s(e, "alignDataLabel", function(a, b, d, e, g, j) {
            if (this.chart.polar) {
        ...
        s(d, "getCoordinates", function(a, b) {
            var c = this.chart,
                d = {
                    xAxis: [],
                    yAxis: []
